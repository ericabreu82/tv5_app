...
/*!
  \file terralib/app/qt/RidgeLinesWidget.h

  \brief A widget used to access the ridge lines method.
*/

#ifndef __TERRALIB_APP_INTERNAL_RIDGELINESWIDGET_H
#define __TERRALIB_APP_INTERNAL_RIDGELINESWIDGET_H
...
namespace Ui { class RidgeLinesWidgetForm; }
...
// Forward declarations
    ...
    class APPPLUGINDLLEXPORT RidgeLinesWidget : public QWidget
    {
      Q_OBJECT

      public:

        RidgeLinesWidget(QWidget* parent = 0);
      ...
      private:
        ...
        std::auto_ptr<Ui::RidgeLinesWidgetForm> m_ui;
...
#endif  // __TERRALIB_APP_INTERNAL_RIDGELINESWIDGET_H
