...
/*!
  \file terralib/app/qt/RidgeLinesWidget.cpp

  \brief A widget used to access the ridge lines method.
*/

#include "RidgeLinesWidget.h"
#include "ui_RidgeLinesWidgetForm.h"

#include "../core/RidgeLines.h"
...
te::app::RidgeLinesWidget::RidgeLinesWidget(QWidget* parent)
  : QWidget(parent),
    m_ui(new Ui::RidgeLinesWidgetForm)
{
// add controls
  m_ui->setupUi(this);
...
te::app::RidgeLinesWidget::~RidgeLinesWidget()
{
}

void te::app::RidgeLinesWidget::setLayerList(std::list<te::map::AbstractLayerPtr>& layerList)
{
...
void te::app::RidgeLinesWidget::onFileToolButtonClicked()
{
...
te::gm::MultiLineString* te::app::RidgeLinesWidget::layerToMultiLine(QComboBox* layerComboBox, std::string layerTitle) {

    te::gm::MultiLineString* lines = 0;
...
te::gm::MultiPolygon* te::app::RidgeLinesWidget::layerToMultiPolygon(QComboBox* layerComboBox, std::string layerTitle) {

    te::gm::MultiPolygon* polys = 0;
...
void te::app::RidgeLinesWidget::execute()
{
  ...
  try
  {
    ...
    if(!executeok)
    {
      std::string errorMsg  = "An exception has occurred: ";
                  errorMsg += ridgeLines.logMessage();
  ...
  {
    std::string errorMsg  = "An unexpected exception has occurred in RidgeLines()!";
  ...
  QMessageBox::information(this, tr("Information"), tr("RidgeLines operation done."));
